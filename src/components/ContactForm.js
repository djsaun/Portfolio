      ...
      <div>
        {this.state.error ? (
          <p className={styles.error}>
            An error occurred while submitting the form. Please try again. If
            the problem persists, please email me at{' '}
            <a href="mailto:djsaun@gmail.com">djsaun@gmail.com</a>
          </p>
        ) : (
          ''
        )}
        {this.state.submitted === true && !this.state.error ? (
          <p className={styles.confirmationMessage}>
            ...
            <br />
            <br />
            I'm reviewing your submission and should get back to you in the next
            24 hours.
          </p>
        ) : (
          <Formik
            ...
            render={({
              ...
              <form
                name="contact"
                action="https://formspree.io/djsaun@gmail.com"
                method="POST"
              ...
              >
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    value={values.name}
                    className={
                      touched.name && errors.name ? styles.hasError : ''
                    }
                  />
                ...
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    value={values.email}
                    className={
                      touched.email && errors.email ? styles.hasError : ''
                    }
                  />
                ...
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    value={values.phone}
                    className={
                      touched.phone && errors.phone ? styles.hasError : ''
                    }
                  />
                ...
                <div className={styles.field}>
                  ...
                  <textarea
                    ...
                    className={
                      touched.message && errors.message ? styles.hasError : ''
                    }
                  />
