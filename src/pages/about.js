...
const About = (props) => {
  return(
    <div>
      <h1>About David</h1>
      <p>I've been developing professionally for five years, most recently as a Front End Web Developer at <a href="https://monkee-boy.com" target="_blank">Monkee-Boy Web Design</a> in Austin, TX. </p>
      ...
      <p>Outside of coding, I really enjoy hiking/backpacking, biking, running, and reading.</p>
    </div>
  )
}
